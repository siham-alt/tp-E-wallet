  ...
  users: [
    {
      ...
      wallet: {
        ...
        transactions: [
          { id: "1", type: "credit", amount: 140, date: "2025-08-14", from: "Ahmed", to: "124847" ,status:"succes"},
          { id: "2", type: "debit", amount: 200, date: "2025-08-13", from: "124847", to: "Amazon" ,status:"succes"},
          { id: "3", type: "credit", amount: 250, date: "2025-08-12", from: "Ahmed", to: "124478" ,status:"succes"}
        ],
        beneficiaries: [
    ...
    },
    {
      ...
      wallet: {
        ...
        transactions: [
          { id: "1", type: "credit", amount: 140, date: "2025-08-14", from: "Ali", to: "12347", status:"succes" },
          { id: "2", type: "debit", amount: 200, date: "2025-08-13", from: "12347", to: "Amazon",status:"succes" },
          { id: "3", type: "credit", amount: 250, date: "2025-08-12", from: "Ali", to: "224478",status:"succes" }
        ],
        beneficiaries: [
...
export const getcards=(id)=>{
  return database.users.find((u)=>u.id===id).wallet.cards;
}

export const findcards=(numcompte,id)=>{
  return database.users.find((u)=>u.id===id).wallet.cards.find((c)=>c.numcards===numcompte);
}
